...
const resetPassword = async (req, res) => {
  try {
    ...
    // Ako odime spored token, ke pobarame account vaka:
    // const account = await getById(req.auth.id);
    // const account = await getById(req.auth.email);
    ...
    if (bcryptjs.compareSync(newPassword, account.password)) {
